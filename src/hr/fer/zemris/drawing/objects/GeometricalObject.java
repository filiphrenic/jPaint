...
/**
 * This class is an super class of all objects that can be drawn in jPaint.
 * 
 * @author Filip Hrenić
 * @version 1.0
 */
...
public abstract class GeometricalObject extends JComponent {
     ...
     * @return message
     */
    protected abstract JPanel createMessage();

    /**
     * Updates the given object.
     */
    protected abstract void updateObject(final JComponent comp);
