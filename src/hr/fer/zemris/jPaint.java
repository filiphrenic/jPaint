...
import hr.fer.zemris.color.CJLabel;
import hr.fer.zemris.color.JColorArea;
import hr.fer.zemris.drawing.Drawer;
import hr.fer.zemris.drawing.JDrawingCanvas;
import hr.fer.zemris.drawing.objects.GeometricalObject;
import hr.fer.zemris.models.DrawingModel;
import hr.fer.zemris.models.DrawingObjectListModel;
import hr.fer.zemris.models.MyModel;
import hr.fer.zemris.util.FileHandler;
...
public class jPaint extends JFrame {
    ...
    private final DrawingModel model = new MyModel();
    private Path path;

    /**
     * Creates a new {@link jPaint} object. Initializes the gui.
     */
    private jPaint() {
    ...
    private void createList() {
        ...
        list.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                model.getObject(index).onClick(jPaint.this.canvas, jPaint.this.canvas);
            }
        });
    ...
    private void createToolbar() {
        ...
        line.addActionListener(e -> drawer.setStatus(Drawer.LINE));

        circle.addActionListener(e -> drawer.setStatus(Drawer.CIRCLE));

        fcircle.addActionListener(e -> drawer.setStatus(Drawer.FCIRCLE));
    ...
    private final Action openFileAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (fc.showOpenDialog(jPaint.this) != JFileChooser.APPROVE_OPTION) {
                return;
            }
    ...
    @SuppressWarnings("serial")
    private final Action saveAsFileAction = new AbstractAction() {
        @Override
        public void actionPerformed(ActionEvent e) {
            JFileChooser fc = new JFileChooser();
            if (fc.showSaveDialog(jPaint.this) != JFileChooser.APPROVE_OPTION) {
                return;
            }
    ...
    @SuppressWarnings("serial")
    private final Action exportFileAction = new AbstractAction() {
        @Override
        public void actionPerformed(ActionEvent e) {
    ...
    private final Action exitAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            if (drawer.hasChanged()) {
                int answer = JOptionPane.showConfirmDialog(jPaint.this, "Do you wish to save this drawing?", "Save?",
    ...
    @SuppressWarnings("serial")
    private final Action clearAll = new AbstractAction() {
        @Override
        public void actionPerformed(ActionEvent e) {
            model.clear();
        }
    ...
    /**
     * Creates a new jPaint frame and sets it's visibility to <code>true</code>.
     * 
     * @param args don't mather
     */
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new jPaint().setVisible(true));
    }
